...
MATSIM_PROCESSING_THREADS="${MATSIM_PROCESSING_THREADS:-0}"
...
JAVA_OPTS="${JAVA_OPTS:--Xms512m -Xmx8g -XX:+UseG1GC -XX:+UseStringDeduplication}"
...
MAP_BASEMAP_DEFAULT="${MAP_BASEMAP_DEFAULT:-configured}"
...
MAP_BASEMAP_DEFAULT=configured
