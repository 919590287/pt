...
public interface RouteService {
    ...
    Map<String, Object> departureTimetable(RouteInfoParam param);

    Map<String, Object> departureBundle(DatasourceParam param);

    Map<String, Object> departurePanel(RouteChartParam param);
