import { Bn as HalfFloatType, Js as WebGLRenderTarget, Oo as ShaderMaterial, ks as UniformsUtils, st as Color } from "./three.module-Chg6xWOA.js";
import { t as CopyShader } from "./CopyShader-DjSow2fq.js";
import { n as Pass, t as FullScreenQuad } from "./Pass-DRDgtP9d.js";
//#region node_modules/three/examples/jsm/postprocessing/SSAARenderPass.js
/**
...
var SSAARenderPass = class extends Pass {
	...
	*/
	constructor(scene, camera, clearColor = 0, clearAlpha = 0) {
		super();
		/**
		* The scene to render.
		*
	...
	*/
	render(renderer, writeBuffer, readBuffer) {
		...
		for (let i = 0; i < jitterOffsets.length; i++) {
			...
			if (this.camera.setViewOffset) this.camera.setViewOffset(viewOffset.fullWidth, viewOffset.fullHeight, viewOffset.offsetX + jitterOffset[0] * .0625, viewOffset.offsetY + jitterOffset[1] * .0625, viewOffset.width, viewOffset.height);
...
//# sourceMappingURL=three_examples_jsm_postprocessing_SSAARenderPass.js.map