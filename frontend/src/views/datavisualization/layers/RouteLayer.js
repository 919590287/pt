...
export class RouteLayer extends Layer {
  ...
  update() {
    try {
      ...
      //   points[points.length] = new THREE.Vector3(segment.from.x - this.center[0], segment.from.y - this.center[1], segment.from.z);
      //   points[points.length] = new THREE.Vector3(segment.to.x - this.center[0], segment.to.y - this.center[1], segment.to.z);
      // }
