    ...
    series: [
      {
        ...
        data: [
          { value: data.direct, name: "直达站点", itemStyle: { color: "#0f9f6e" } },
          { value: data.transfer1, name: "一次换乘可达", itemStyle: { color: "#2f75d6" } },
          { value: data.transfer2, name: "二次换乘可达", itemStyle: { color: "#d97706" } }
        ]
      }
    ]
  };
